...
public class Distancias {
    ...
    public static void distanciaATiempo(String street, String Distance, String Time) {
        ...
        btnCalcular.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                campoDistancia.setText(Distance);
                campoTiempo.setText(Time);
            }
        });
