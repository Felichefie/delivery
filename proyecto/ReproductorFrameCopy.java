...
public class ReproductorFrameCopy extends JFrame {
    ...
    public ReproductorFrameCopy(int modelo, String Correo) {
        //Variables base------
        if(modelo==1){
        ...
        btn_cambiodediseño.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(modelo.equals("Nor")){
                    dispose(); // Cierra el frame actual
                    new ReproductorFrameCopy(1, Correo).setVisible(true); // Abre el nuevo frame
                }else if(modelo.equals("Nav")){  
                    dispose(); // Cierra el frame actual
                    new ReproductorFrameCopy(2,Correo).setVisible(true); // Abre el nuevo frame
                }else if(modelo.equals("Madre")){  
                    dispose(); // Cierra el frame actual
                    new ReproductorFrameCopy(3,Correo).setVisible(true); // Abre el nuevo frame
                }else if(modelo.equals("Haw")){  
                    dispose(); // Cierra el frame actual
                    new ReproductorFrameCopy(4, Correo).setVisible(true); // Abre el nuevo frame
                }else if(modelo.equals("Osc")){  
                    dispose(); // Cierra el frame actual
                    new ReproductorFrameCopy(5, Correo).setVisible(true); // Abre el nuevo frame
                }else if(modelo.equals("Inde")){  
                    dispose(); // Cierra el frame actual
                    new ReproductorFrameCopy(6, Correo).setVisible(true); // Abre el nuevo frame
                }else if(modelo.equals("Amor")){  
                    dispose(); // Cierra el frame actual
                    new ReproductorFrameCopy(7, Correo).setVisible(true); // Abre el nuevo frame
                }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new ReproductorFrameCopy(5, correo);
            }
        });
    }
