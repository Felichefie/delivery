    ...
    public static void direccion() {
        ...
        btnAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                address.setStreet(campoCalle.getText());
                address.setNeighborhood(campoColonia.getText());
                if(campoNumExterior.getText().equals("")){
                    address.setNumber(0);
                }else{
                    address.setNumber(Integer.parseInt(campoNumExterior.getText()));
                }
                address.setNumber_two(campoNumInterior.getText());
                address.setPostal_code(campoCodigoPostal.getText());

                if(address.getStreet().equals("") || address.getNeighborhood().equals("") || address.getNumber() == 0 || address.getPostal_code().equals("")){
                    JOptionPane.showMessageDialog(inicio, "¡Faltan campos por llenar!", "Error", JOptionPane.ERROR_MESSAGE);
                }else{
                    Distancia con = new Distancia("GET", address);
                    ...
                    Distancias.distanciaATiempo(address.getStreet(), distanceText, durationText);
                    inicio.dispose();
        ...
        btnCancelar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                campoNumExterior.setText("");
                campoNumInterior.setText("");
