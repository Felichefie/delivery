public class Direccion {
    ...
    Direccion (String calle_numero, String colonia, String ciudad, String estado, int codigo_postal){
    ...
    Direccion (String calle_numero, String colonia, String ciudad, String estado, int codigo_postal, String referencia, String pais){
        this.calle_numero = calle_numero;
        this.colonia = colonia;
        this.ciudad = ciudad;
        this.pais = pais;
