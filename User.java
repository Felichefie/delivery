...
public class User {
    private JLabel lbl_nom, lbl_userName, lbl_first, lbl_second, lbl_name, lbl_birth, lbl_email, lbl_phone;
    ...
    User() {
        ...
        lbl_nom = new JLabel("Jaime Jair Raya Castellon.");
        lbl_nom.setBounds(0,0,300,30);
        lbl_userName = new JLabel("USER NAME:");
        lbl_userName.setBounds(0,20,300,30);
        lbl_userName.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_first = new JLabel("FIRST LASTNAME:");
        lbl_first.setBounds(0,90,300,30);
        lbl_first.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_second = new JLabel("SECOND LASTNAME:");
        lbl_second.setBounds(0,160,300,30);
        lbl_second.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_name = new JLabel("NAME:");
        lbl_name.setBounds(0,230,300,30);
        lbl_name.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_birth = new JLabel("BIRTHDAY:");
        lbl_birth.setBounds(0,300,300,30);
        lbl_birth.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_email = new JLabel("EMAIL:");
        lbl_email.setBounds(0,370,300,30);
        lbl_email.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_phone = new JLabel("PHONE NUMBER:");
        lbl_phone.setBounds(0,440,300,30);
        lbl_phone.setFont(new Font("Constantia", Font.PLAIN, 14));
        

        txt_userName = new JTextField();
        txt_userName.setBounds(0, 50, 250, 25);
        txt_first = new JTextField();
        txt_first.setBounds(0, 120, 250, 25);
        txt_second = new JTextField();
        txt_second.setBounds(0, 190, 250, 25);
        txt_name = new JTextField();
        txt_name.setBounds(0, 260, 250, 25);
        txt_birth = new JTextField();
        txt_birth.setBounds(0, 330, 250, 25);
        txt_email = new JTextField();
        txt_email.setBounds(0, 400, 250, 25);
        txt_phone = new JTextField();
        txt_phone.setBounds(0, 470, 250, 25);
        ...
        btn_buscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(u.getId() == 0){
                    JOptionPane.showMessageDialog(btn_buscar,"DATOS INGRESADOS NO ENCONTRADOS");
                    System.out.println("NO EXISTE.");
        
                }else{

                    JOptionPane.showMessageDialog(btn_buscar,"DATOS DE USUARIO ENCONTRADOS.");
                    ...
                    if(a.getId() == 0){
                        JOptionPane.showMessageDialog(btn_buscar,"ESTE USUARIO NO TIENE DIRECCIONES.");
                        ...
                        Dir dir = new Dir();
                        JOptionPane.showMessageDialog(btn_buscar,"ESTE USUARIO AGREGO DIRECCIONES.");
        ...
        btn_register.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                ...
                JOptionPane.showMessageDialog(btn_register,"DATOS AGREGADOS EXITOSAMENTE.");
            }
        });
