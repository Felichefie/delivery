...
public class User {
    private JLabel lbl_yo, lbl_userName, lbl_first, lbl_second, lbl_name, lbl_birth, lbl_email, lbl_phone;
    ...
    User() {
        ...
        btn_buscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(u.getId() == 0){
                    JOptionPane.showMessageDialog(btn_buscar,"El usuario no existe, ingrese sus datos");
