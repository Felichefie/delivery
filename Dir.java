...
public class Dir {
    ...
    Dir() {
        ...
        lbl_street.setBounds(0,20,300,30);
        lbl_street.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_number = new JLabel("NUMBER:");
        lbl_number.setBounds(0,90,300,30);
        lbl_number.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_number_two = new JLabel("NUMBER TWO:");
        lbl_number_two.setBounds(0,160,300,30);
        lbl_number_two.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_neighborhood = new JLabel("COLONY:");
        lbl_neighborhood.setBounds(0,230,300,30);
        lbl_neighborhood.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_city = new JLabel("CITY:");
        lbl_city.setBounds(0,300,300,30);
        lbl_city.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_state = new JLabel("STATE:");
        lbl_state.setBounds(0,370,300,30);
        lbl_state.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_country = new JLabel("COUNTRY:");
        lbl_country.setBounds(0,440,300,30);
        lbl_country.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_postal = new JLabel("POSTAL CODE:");
        lbl_postal.setBounds(0,510,300,30);
        lbl_postal.setFont(new Font("Constantia", Font.PLAIN, 14));

        txt_street = new JTextField();
        txt_street.setBounds(0, 50, 250, 25);
        txt_number = new JTextField();
        txt_number.setBounds(0, 120, 250, 25);
        txt_number_two = new JTextField();
        txt_number_two.setBounds(0, 190, 250, 25);
        txt_neighborhood = new JTextField();
        txt_neighborhood.setBounds(0, 260, 250, 25);
        txt_city = new JTextField();
        txt_city.setBounds(0, 330, 250, 25);
        txt_state = new JTextField();
        txt_state.setBounds(0, 400, 250, 25);
        txt_country = new JTextField();
        txt_country.setBounds(0, 470, 250, 25);
        txt_postal = new JTextField();
        txt_postal.setBounds(0, 540, 250, 25);
