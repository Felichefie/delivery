...
public class Loc {
    ...
    Loc() {
        ...
        lbl_lon.setBounds(0,20,300,30);
        lbl_lon.setFont(new Font("Constantia", Font.PLAIN, 14));
        lbl_lat = new JLabel("LATITUDE:");
        lbl_lat.setBounds(0,90,300,30);
        lbl_lat.setFont(new Font("Constantia", Font.PLAIN, 14));

        txt_lon = new JTextField();
        txt_lon.setBounds(0, 50, 250, 25);
        txt_lat = new JTextField();
        txt_lat.setBounds(0, 120, 250, 25);
        ...
        btn_register.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                ...
                JOptionPane.showMessageDialog(btn_register,"DATOS INFRESADOS CORRECTAMENTE.");
            }
        });
