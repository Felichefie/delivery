        ...
        btnPagar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if ("Transferencia".equals(metodoSeleccionado)) {
                    ...
                    if("".equals(clabe)){
                        JOptionPane.showMessageDialog(inicio, "Ingrese una CLABE", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }else{
                    ...
                    if("".equals(numCuenta)){
                        JOptionPane.showMessageDialog(inicio, "Ingrese un número de cuenta", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }else{
